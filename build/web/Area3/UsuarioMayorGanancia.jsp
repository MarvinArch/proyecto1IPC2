<%-- 
    Document   : UsuarioMayorGanancia
    Created on : 6/09/2021, 08:27:53
    Author     : alpha
--%>
...
<html>
    <head>
        ...
        <title>Usuario con la mejor ganacia</title>
        <script>
            ...
            // Download it
            var filename = 'Reporte_Vendedor_de_Mayor_Ganancia_' + fecha_In + '_al_' + fecha_fin+ '.csv';
    ...
    <body>
        ...
        <h1 class='centro'>Usuario con la Mejor Ganancia</h1>
