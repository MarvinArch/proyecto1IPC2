<%-- 
    Document   : ReporteGanacias
    Created on : 6/09/2021, 04:59:26
    Author     : alpha
--%>
...
<html>
    <head>
        ...
        <title>Reporte de Ganacias</title>
        <script>
            ...
            // Download it
            var filename = 'Reporte_Ganacias_del_' + fecha_In + '_al_' + fecha_fin+ '.csv';
    ...
    <body>
        ...
        <h1 class='centro' >Reporte de Ganancias por Intervalo de tiempo</h1>
        <form action="../Reportes?c=c" method="POST">
            <div class="centro">
                <h3>Ingrese Fecha Inicial <input type="date" name="inicio"> &nbsp;&nbsp;&nbsp;&nbsp;Ingrese Fecha Final <input type="date" name="final"></h3>
                <input type="submit" name="reportetiempo" value="Generar Reporte">
            </div>
        </form>
            <%
                try {
