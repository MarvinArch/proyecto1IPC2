<%-- 
    Document   : ReportesVentasTiempo
    Created on : 6/09/2021, 00:55:27
    Author     : alpha
--%>
...
<html>
    <head>
        ...
        <title>Reporte de Ventas intervalo Tiempo</title>
        <script>
            ...
            // Download it
            var filename = 'Reporte_Ventas_del_' + fecha_In + '_al_' + fecha_fin+ '.csv';
    ...
    <body>
        ...
        <h1 class="centro">Reporte de Ventas por Intervalo de Tiempo</h1>
